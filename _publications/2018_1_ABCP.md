...
excerpt: 'Proposed a routing protocol for MANETs (Mobile Ad-hoc Networks) called the Acceptability Based Clustering Routing Protocol (ABCP), which ensures secure routing through the network: by electing a Cluster head on the basis of Acceptability score.'
date: 2018-11-01
